 ...
 */
public class PokedexArrayAdapter extends ArrayAdapter<Pokemon> implements Filterable, SectionIndexer {
    ...
    public PokedexArrayAdapter(Context context, int layoutResourceId, ArrayList<Pokemon> objects) {
